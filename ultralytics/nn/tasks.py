...
class PoseModel(DetectionModel):
    ...
    This class extends DetectionModel to handle pose estimation tasks, providing specialized loss computation for
    ...
    Examples:
        ...
        >>> model = PoseModel("yolo26n-repvit-face-pose-slim.yaml", ch=3, nc=1, data_kpt_shape=(5, 3))
        >>> results = model.predict(image_tensor)
    """
    ...
    def _load():
        with temporary_modules(
            ...
            attributes={
                ...
                "ultralytics.utils.loss.v10DetectLoss": "ultralytics.utils.loss.E2ELoss",  # YOLOv10 (E2EDetectLoss removed)
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in frozenset({Detect, Pose, Pose26}):
...
def guess_model_task(model):
    ...
    Returns:
        (str): Task of the model ('detect', 'pose').
    """
    ...
    LOGGER.warning(
        ...
        "Explicitly define task for your model, i.e. 'task=detect' or 'pose'."
    )
